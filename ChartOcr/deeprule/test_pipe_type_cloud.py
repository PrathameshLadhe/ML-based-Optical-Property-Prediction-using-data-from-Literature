...
def test(image_path, data_type=1, debug=False, suffix=None, min_value_official=None, max_value_official=None):
...
def parse_args():
    ...
    parser.add_argument("--result_path", dest="result_path", help="where to save results", default="save", type=str)
    parser.add_argument("--type", dest="type", help="type of images", default="Line", type=str)
    parser.add_argument("--data_dir", dest="data_dir", default="data/linedata(1028)", type=str)
    parser.add_argument('--cache_path', dest="cache_path",default="data/linedata(1028)/cache", type=str)
...
if __name__ == "__main__":
    ...
    for image in tqdm(images):
        ...
        data = test(path)
        rs_dict[image] = data
    with open(save_path+'/file.json', "w") as f:
        json.dump(rs_dict, f)
